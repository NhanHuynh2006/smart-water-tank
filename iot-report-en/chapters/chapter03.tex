...
\hline
JSN-SR04T ultrasonic, Hall turbine flow, ACS712 & Level, flow rate and current presence sensing \\
\hline
Two mechanical float switches & Overflow guard and source tank empty guard \\
\hline
...
\hline
10 k$\Omega$ and 20 k$\Omega$ resistors, 5 V 3 A supply & Three divider networks and system power \\
\hline
\end{tabular}
\end{table}
